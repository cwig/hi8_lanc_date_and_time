...
#define cmdPinON (PORTD |= B00010000)    // Set digital pin 4 (PD4)
#define cmdPinOFF (PORTD &= B11101111)   // Reset digital pin 4 (PD4)
#define ledON (PORTB |= B00001000)       // Set LED pin 13 (PB3)
#define ledOFF (PORTB &= B11110111)      // Reset LED pin 13 (PB3)
#define lancPinREAD (PIND & B00001000)   // Read pin 3 (PD3)
#define lancRepeats 4                    // Repeat LANC command (4 frames default)
...
//  VPORTE.DIR |= B00000100;    // Config ledPin as output (high)
  ...
  // Config cmdPin as output (high)
  DDRD |= B00010000;   // Set PD4 as output (digital pin 4)
  // Config lancPin as input (low)
  DDRD &= B11110111;   // Clear PD3 to set as input (digital pin 3)
  // Config ledPin as output (high)
  DDRB |= B00100000;   // Set PB5 as output (digital pin 13)
  // Reset LANC control pin (LANC line becomes high)
  PORTD &= B11101111;  // Clear PD4 (digital pin 4) to set low
